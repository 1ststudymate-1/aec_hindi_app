...
const UNIT_META: Record<string, { title: string; blurb: string; outcome: string }> = {
  "1": {
    ...
    blurb:
      "पत्र के सभी प्रकार — अनौपचारिक, औपचारिक, आवेदन-पत्र, व्यावसायिक पत्र, संपादक को पत्र — प्रारूप और नमूनों के साथ; तथा पर्यावरण, नैतिकता, विज्ञान, साहित्य और राष्ट्रीयता पर पूर्ण मॉडल निबंध। स्वास्थ्य का निबंध अतिरिक्त अभ्यास है।",
    outcome:
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="relative w-full max-w-xs">
            ...
            <Input
              ...
              aria-label="अध्याय का नाम खोजें"
              className="pl-9"
